	...
	protected void setPage(boolean successDownload) {
		...
		if(successDownload) {
			try {
				...
				if(!TextUtils.isEmpty(strEmail) && strEmail.contains("@")) {
		...
		AsyncStringDownloader.download(url, downloadKey, new OnCompletedListener() {
			...
			public void onCompleted(String url, String result) {
				...
				try {
					...
					if(objData.has("push_all") && !TextUtils.isEmpty(objData.getString("push_all"))
					...
					if(objData.has("push_message") && !TextUtils.isEmpty(objData.getString("push_message"))
					...
					if(objData.has("push_reply") && !TextUtils.isEmpty(objData.getString("push_reply"))
