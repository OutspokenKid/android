		...
		for(int i=0; i<4; i++) {
			...
			bgMenu.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(I == 3 && myStoryInfo != null && !TextUtils.isEmpty(myStoryInfo.getMystory_member_id()) 
...
//			@Override
//			public void onClick(View v) {
//				if(!TextUtils.isEmpty(myStoryInfo.getFacebook())) {
...
//			public void onClick(View v) {
//
//				if(!TextUtils.isEmpty(myStoryInfo.getKakao())) {
...
//			public void onClick(View v) {
//				
//				if(!TextUtils.isEmpty(myStoryInfo.getMystory_mobile_no())) {
...
//		rp.addRule(RelativeLayout.BELOW, madeCount + 3);
	...
	public void setMyStoryInfo() {
		...
		if(!TextUtils.isEmpty(myStoryInfo.getMystory_member_nickname())) {
		...
		if(!TextUtils.isEmpty(myStoryInfo.getMystory_member_id())) {
		...
		if(!TextUtils.isEmpty(myStoryInfo.getMystory_title())) {
			tvIntroduce.setText(myStoryInfo.getMystory_title());
		} else {
			tvIntroduce.setText(R.string.noContent);
		}
		
		if(!TextUtils.isEmpty(myStoryInfo.getMystory_spot_cnt())) {
			tvPostCount.setText(myStoryInfo.getMystory_spot_cnt());
		}
		
		if(!TextUtils.isEmpty(myStoryInfo.getMystory_friend_plus_cnt())) {
		...
		if(!TextUtils.isEmpty(myStoryInfo.getMstatus_name())) {
			tvStatus.setText(myStoryInfo.getMstatus_name());
		}
		
		if(!TextUtils.isEmpty(myStoryInfo.getIlike())) {
