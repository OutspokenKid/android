...
/////////////////////////////////////////// Classes.
	...
	public class ImageFrame extends FrameLayout {
		...
		public void init() {
			...
			ivImage.setOnScrollChangedListener(new PinchImageView.OnScrollChangedListener() {
		...
		public void downloadImage() {
			...
			BitmapDownloader.downloadImmediately(url, null, ocl, null, ivImage, true);
		}
	...
	public class ThumbnailFrame extends FrameLayout {
		...
		public void download() {
			...
			BitmapDownloader.downloadImmediately(url, null, ocl, null, ivThumbnail, true);
		}
