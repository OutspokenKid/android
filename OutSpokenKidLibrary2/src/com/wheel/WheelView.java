...
public class WheelView extends View {
    ...
    private void layout(int width, int height) {
        ...
        private void doScroll(int delta) {
        	...
        	if(!allowOverScroll) {
        		if(currentItem == 0 && scrollingOffset + delta > 0) {
            		return;
            	} else if(currentItem == viewAdapter.getItemsCount() - 1 && scrollingOffset + delta < 0) {
            		return;
            	}
        	}
    ...
    public void allowOverScroll(boolean allowOverScroll) {
