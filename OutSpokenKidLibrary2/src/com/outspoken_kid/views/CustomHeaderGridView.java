 ...
 *
 */
public class CustomHeaderGridView extends android.widget.GridView implements OnScrollListener, android.widget.AdapterView.OnItemClickListener
{
    ...
    public class mListAdapter extends BaseAdapter
    {
		...
		public int getCount() 
		{
			return originalAdapter.getCount() > 0 ? originalAdapter.getCount() + CustomHeaderGridView.this.getNumColumnsCompat() : 0;
		}

		@Override
		public Object getItem(int position) 
		{
			return originalAdapter.getItem(position + CustomHeaderGridView.this.getNumColumnsCompat());
		}

		@Override
		public long getItemId(int position) 
		{
			return originalAdapter.getItemId(position + CustomHeaderGridView.this.getNumColumnsCompat());
		}
		...
		{
			if ( position < CustomHeaderGridView.this.getNumColumnsCompat() )
			{
		...
		public View getView(int position, View convert, ViewGroup parent) 
		{
			if ( position < CustomHeaderGridView.this.getNumColumnsCompat() )
			{
				...
				int realPosition = position - CustomHeaderGridView.this.getNumColumnsCompat();
	...
	public void onItemClick(AdapterView<?> adapter, View view, int position, long id) 
	{
		...
		{
			clickListenerFromActivity.onItemClick(adapter, view, position - CustomHeaderGridView.this.getNumColumnsCompat(), id);
		}
	}
}