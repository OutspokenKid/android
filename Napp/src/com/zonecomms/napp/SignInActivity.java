...
///////////// Custom methods.
	...
	public void launchToSignUpActivity(String email, String gender, String birthday, String profile) {
		...
		startActivityForResult(intent, ZoneConstants.REQUEST_SIGNUP);
		overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
	}
