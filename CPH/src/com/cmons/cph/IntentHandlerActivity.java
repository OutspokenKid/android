...
//				
//				Intent shopActivityIntent = new Intent(this, 
//						(ShopActivity.getInstance() instanceof WholesaleActivity?
//								WholesaleActivity.class :
//								RetailActivity.class));
//				shopActivityIntent.addFlags(Intent.FLAG_ACTIVITY_BROUGHT_TO_FRONT);
//				startActivity(shopActivityIntent);
//				
//				if(intent.getData() != null) {
//					LogUtils.log("###IntentHandlerActivity.handlingIntent.  On mainActivity, has data");
//					ShopActivity.getInstance().handleUri(intent.getData());
//				}
//			} else {
