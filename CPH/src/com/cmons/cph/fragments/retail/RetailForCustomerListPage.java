...
public class RetailForCustomerListPage extends CmonsFragmentForRetail {
	...
	public void bindViews() {
		...
		btnRequest = (Button) mThisView.findViewById(R.id.retailCustomerListPage_btnRequest);
		btnPartner = (Button) mThisView.findViewById(R.id.retailCustomerListPage_btnPartner);
		tvCustomer = (TextView) mThisView.findViewById(R.id.retailCustomerListPage_tvCustomer);
		editText = (EditText) mThisView.findViewById(R.id.retailCustomerListPage_editText);
		btnSearch = (Button) mThisView.findViewById(R.id.retailCustomerListPage_btnSearch);
		
		listView = (ListView) mThisView.findViewById(R.id.retailCustomerListPage_listView);
		
		popupRelative = (RelativeLayout) mThisView.findViewById(R.id.retailCustomerListPage_popupRelative);
		btnClose = (Button) mThisView.findViewById(R.id.retailCustomerListPage_btnClose);
		tvShopName = (TextView) mThisView.findViewById(R.id.retailCustomerListPage_tvShopName);
		tvOwnerName = (TextView) mThisView.findViewById(R.id.retailCustomerListPage_tvOwnerName);
		tvPhone = (TextView) mThisView.findViewById(R.id.retailCustomerListPage_tvPhone);
		tvCategory = (TextView) mThisView.findViewById(R.id.retailCustomerListPage_tvCategory);
		tvAddress = (TextView) mThisView.findViewById(R.id.retailCustomerListPage_tvAddress);
		btnConfirm = (Button) mThisView.findViewById(R.id.retailCustomerListPage_btnConfirm);
	}
	...
	public void downloadInfo() {
		...
		url = CphConstants.BASE_API_URL + "retails/notices";
		super.downloadInfo();
	}
