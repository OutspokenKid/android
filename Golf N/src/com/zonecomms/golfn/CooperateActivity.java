...
public class CooperateActivity extends Activity {
	...
	public void bindViews() {
		...
		btnSubmit = (FrameLayout) findViewById(R.id.cooperateActivity_btnSubmit);
		...
		btnSubmit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(etTitle.getEditText().getText() != null
						&& !StringUtils.isEmpty(etTitle.getEditText().getText().toString())
						
						&& etCompany.getEditText().getText() != null
						&& !StringUtils.isEmpty(etCompany.getEditText().getText().toString())
						
						&& etPhoneNumber.getEditText().getText() != null
						&& !StringUtils.isEmpty(etPhoneNumber.getEditText().getText().toString())
						
						&& etEmail.getEditText().getText() != null
						&& !StringUtils.isEmpty(etEmail.getEditText().getText().toString())
						
						&& etContent.getEditText().getText() != null
						&& !StringUtils.isEmpty(etContent.getEditText().getText().toString())) {
