...
//					intent.setAction(Intent.ACTION_GET_CONTENT);
	...
	protected void setPage(boolean successDownload) {
		...
		LogUtils.log("###UserPage.setPage.  sd : " + successDownload);
...
//		rp.addRule(RelativeLayout.BELOW, madeCount + 3);
	...
	public void loadPosts() {
		...
		LogUtils.log("###UserPage.loadPosts.  =======" +
				"\niD : " + isDownloading +
				"\niLL : " + isLastList +
				"\nmode : " + mode +
				"\n==========");
						...
						if(length > 0) {
							for(int i=0; i<length; i++) {
								try {
									...
									if(mode == 2 && MainActivity.myInfo.getMember_id().equals(userId)) {
										post.setFromScrap(true);
									}
