...
//	private boolean isCertifier;
	...
	public void bindViews() {
		...
		btnEditDealerInfo = (Button) mThisView.findViewById(R.id.dealerPage_btnEditDealerInfo);
...
//				&& getArguments().containsKey("isCertifier")
				) {
...
//		}
	...
	public void setListeners() {
		...
		btnEditDealerInfo.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				...
				mActivity.showPage(BCPConstants.PAGE_EDIT_DEALER_INFO, bundle);
			}
		});
	...
	public void setSizes() {
		...
		rp.bottomMargin = ResizeUtils.getSpecificLength(22);
